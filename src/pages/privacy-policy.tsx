  ...
  return (
    <Body>
      ...
      <Body.PrivacyWrapper>
        ...
        <Body.PrivacyText>
          Your privacy is important to us. It is Igarra Names&#39; policy to
          ...
          across our website,
          <Link href="https://igarranames.com"> igarranames.com</Link>, and
          other sites we own and operate.
        </Body.PrivacyText>
        <Body.PrivacyText>
          This policy is effective as of 30 May 2022 and was last updated on 30
          May 2022.{" "}
        </Body.PrivacyText>

        <Body.Heading>Information We Collect</Body.Heading>
        <Body.PrivacyText>
        ...
        <Body.Heading>Log Data</Body.Heading>
        <Body.PrivacyText>
        ...
        <Body.Heading>Personal Information</Body.Heading>
        <Body.PrivacyText>
        ...
        <Body.UnorderedList>
          <Body.ListItem>Name</Body.ListItem>
          <Body.ListItem>Email</Body.ListItem>
          <Body.ListItem>Social Media Profiles</Body.ListItem>
        </Body.UnorderedList>
        ...
        <Body.Heading>Collection and Use of Information</Body.Heading>
        <Body.PrivacyText>
        ...
        <Body.UnorderedList>
          ...
          <Body.ListItem>When you mention us on social media</Body.ListItem>
        </Body.UnorderedList>
        ...
        <Body.UnorderedList>
          ...
          <Body.ListItem>to contact and communicate with you</Body.ListItem>
        ...
        <Body.Heading>Security of Your Personal Information</Body.Heading>
        ...
        <Body.Heading>How Long We Keep Your Personal Information</Body.Heading>
        ...
        <Body.Heading>Use of Cookies</Body.Heading>
        <Body.PrivacyText>
        ...
        <Body.Heading>Limits of Our Policy</Body.Heading>
        <Body.PrivacyText>
        ...
        <Body.Heading>Changes to This Policy</Body.Heading>
        ...
        <Body.Heading>Contact Us</Body.Heading>

        <Body.PrivacyText>
          For any questions or concerns regarding your privacy, you may contact
          us:
        </Body.PrivacyText>
        <Link href="https://igarranames.com/contact">Contact Us</Link>
      </Body.PrivacyWrapper>
