  ...
  return (
    <Body.PrivacyWrapper>
      ...
      <Body.PrivacyText>
        ...
        across our website,
        <Link href="https://igarranames.com"> igarranames.com</Link>, and other
      ...
      <Body.UnorderedList default>
        <Body.ListItem default>Name</Body.ListItem>
        <Body.ListItem default>Email</Body.ListItem>
        <Body.ListItem default>Social Media Profiles</Body.ListItem>
      </Body.UnorderedList>
      ...
      <Body.PrivacyText>
        ...
        us: <Link href="https://igarranames.com/contact">Contact Us</Link>
      </Body.PrivacyText>
    </Body.PrivacyWrapper>
  );
};
